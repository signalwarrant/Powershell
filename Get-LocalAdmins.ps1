<#
    .SYNOPSIS
        ...
        outputs the result to a CSV file. For those with PowerShell v5.1,
        use the Get-Localgroupmember CMDlet it will do the same thing. 
        
        This function is only needed for backward compatibility with older
